...
export const ThemeCustomizer = ({ toggle }: P) => {
  return (
    <div className="flex justify-end xs:w-[240px] sm:w-[300px] w-full">
      <div className="flex flex-col w-full h-full shadow-lg overflow-y-auto">
